...
much faster than using poke.Therefore instead of messing with the programmer , I just used an extremely easy way, by sending 
a read storage command to the programmer.It will read the target data from the MMC to a fixed buffer in RAM (0x80100000).
